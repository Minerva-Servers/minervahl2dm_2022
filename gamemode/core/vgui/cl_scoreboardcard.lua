...
function PANEL:OnMousePressed(key)
	...
	if ( key == MOUSE_RIGHT ) then
		...
		if ( IsValid(minerva.ui.infoCard) ) then 
			minerva.ui.infoCard:Remove() 
		end
		
		minerva.ui.infoCard = vgui.Create("minerva.PlayerInfoCard")
		minerva.ui.infoCard:SetPlayer(self.Player)
	end
end

vgui.Register("minerva.ScoreboardCard", PANEL, "DPanel")
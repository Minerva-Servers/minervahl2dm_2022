concommand.Add("minerva_debug_pos", function(ply)
...
concommand.Add("minerva_debug_eyepos", function(ply)
...
concommand.Add("minerva_debug_ang", function(ply)
...
concommand.Add("minerva_debug_getbones", function(ply)
...
concommand.Add("minerva_debug_getattachments", function(ply)
    local ent = ply:GetEyeTrace().Entity
    if not ( ent and IsValid(ent) ) then
        print("Invalid entity")
        return
